...
public class Problem3_Dowie {
	   ...
	   public static void main(String args[]){
	       String[] topic={"Sports","Religion","Fashion","Music","Movies"}; 
	       ...
	       int maxPeople=0,minPeople=100000,maxTopic=0,minTopic=0;
	       for(i=0;i<5;i++)
	       {
	           int total=0,count=0;
	           for(int j=1;j<=10;j++)
	       ...
	       System.out.println(topic[maxTopic]+" "+maxPeople);
	       System.out.println("Min Point Topic "+"Total Rating");
	       System.out.println(topic[minTopic]+" "+minPeople);
	   }
	}